...
def generate_css(directory):
    ...
    """
    (directory / "styles.css").write_text("@import \"css/codehilite.css\";")

def generate_codehilite(directory):
    (directory / "codehilite.css").write_text("""pre { line-height: 125%; }
